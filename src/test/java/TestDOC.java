...
public class TestDOC extends Base{
    ...
    public void testListElementBy() {
        List<WebElement> dropDownElements = driver.findElements(By.className(("dropdown-")));
        ListMethods.printListText(dropDownElements);

        List<WebElement> imageElements = driver.findElements(By.className("price"));
        ListMethods.printListText(imageElements);
    }
